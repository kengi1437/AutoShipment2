 ...
 */
namespace Eastz\AutoShipment\Model\Shipping;
...
class LabelGenerator
{
    ...
    /**
     * @var \Eastz\AutoShipment\Model\Shipping\LabelsFactory
     */
    ...
    public function __construct(
        ...
        \Eastz\AutoShipment\Model\Shipping\LabelsFactory $labelFactory,
     ...
     */
    public function create(\Magento\Sales\Model\Order\Shipment $shipment, $requestData)
    {
        ...
        $shipment->setPackages($requestData['packages']);


        // $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
        // $this->labelFactory = $objectManager->create(\Eastz\AutoShipment\Model\Shipping\LabelsFactory::class);
